...
exports.QualityReportGenerator = void 0;
...
<body>
            ...
            <tbody>
                ${data.results.map(result => `
                    <tr>
                        ...
                        ${(() => {
            const allowed = ['free', 'starter', 'viral'];
            const tier = allowed.includes(result.tier) ? result.tier : 'free';
    ...
    static async saveHTMLReport(data, filename) {
        try {
...
exports.QualityReportGenerator = QualityReportGenerator;
...
function generateTierChart(results) {
    const tierScores = {
        free: [],
        starter: [],
        viral: []
...
//# sourceMappingURL=quality-report-generator.js.map