...
async function generateAsset(type, prompt, tokenSymbol, config) {
...
function optimizePrompt(prompt, type, tokenSymbol, config) {
    ...
    return `${prompt}${cryptoContext}, ${typeOptimizations[type]}${qualityBoost}`;
}
